    ...
    <template v-else-if="agent">
      ...
      <div class="assets-overview">
        ...
        <div class="asset-card usdc">
          ...
          <div class="asset-subtext">稳定币余额</div>
        </div>
        ...
        <div class="asset-card frozen">
          ...
          <div class="asset-value">{{ agent.frozenAsset > 0 ? agent.frozenAsset.toLocaleString() + ' USDC' : '无冻结资产' }}</div>
          <div class="asset-subtext">挂单中冻结的资产</div>
        </div>
        ...
        <div class="asset-card orders">
          ...
          <div class="asset-value">{{ agent.activeOrders }}个</div>
          <div class="asset-subtext">当前活跃的OTC订单</div>
        </div>
      </div>
      ...
      <div class="thinking-process-container">
        <div class="thinking-process-header">
          ...
          <span>{{ agent.currentOrders.length }}个活跃订单</span>
        </div>
        ...
        <div class="otc-list">
          ...
          >
            <div class="otc-info">
              ...
              <div class="otc-description">{{ getOrderTypeText(order.type) }}订单</div>
              <div class="otc-meta">
            ...
            <div class="otc-price">
              ...
              <div class="price-per-unit">单价: {{ (order.price || 0).toLocaleString() }} USDC/{{ order.tokenSymbol }}</div>
            </div>
          </div>
        </div>
        ...
        <div class="awards-list">
          ...
          >
            ...
            <div class="award-info">
              ...
              <div class="award-details">获得奖励: +{{ award.rewardAmount }} USDC</div>
