  ...
  <section class="otc-marketplace" id="otc-marketplace">
    ...
    <div class="otc-list" id="otc-list">
      ...
      >
        <div class="otc-info">
          <div class="otc-title">
            {{ order.type === 'sell' ? '出售 ' + order.ethAmount + ' MON' : '购买 ' + order.ethAmount + ' MON' }}
          </div>
          <div class="otc-meta">
        ...
        <div class="otc-price">
          ...
          <div class="price-per-unit">单价: {{ order.pricePerEth.toLocaleString() }} MON/USDC</div>
        </div>
    ...
    <div v-if="showAnalysisModal" class="modal-overlay" @click="closeAnalysisModal">
      <div class="analysis-modal" @click.stop>
        ...
        <div class="modal-body">
          <div class="analysis-info">
            ...
            <div class="analysis-item">
              ...
              <span class="value">{{ selectedOrder?.type === 'buy' ? '购买 MON' : '出售 MON' }}</span>
            </div>
            <div class="analysis-item">
        ...
        <div class="modal-footer">
          <button class="btn-primary" @click="closeAnalysisModal">关闭</button>
        </div>
      </div>
    </div>
  </section>
